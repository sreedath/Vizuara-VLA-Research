...
## Key Results (1101 Findings, 196 Experiments on Real OpenVLA-7B)
...
| 338 | Robustness Limits | 0.001% night/noise threshold; fog on white undetectable; JPEG Q=95 detected; drift×corruption interaction |
| 339 | Summary Validation | 20/20 scenes AUROC=1.0; 5/5 prompts perfect; bit-identical determinism; 50/50 deployment frames correct |
| 340 | Threshold Optimization | Benign↔corrupt overlap; d>0 best F1=0.91; noise undetectable with JPEG; calibrate through pipeline |
| 341 | Cross-Corruption Manifold | Fog≈frost (20°); 6D overall manifold; noise+blur non-commutative; 56% linear superposition |
| 342 | Adversarial Analysis | Evasion 98% reduction but never d=0; night resists attack (87%); 1 pixel detected |
...
| 356 | Online Threshold | CUSUM 1-frame delay; fixed>>adaptive (F1 1.0 vs 0.18); Page-Hinkley fails |
| 357 | Multi-Corruption Composition | Subadditive 53-91%; noise+blur non-commutative 85×; all-four AUROC=1.0 |
| 358 | Embedding Clustering | 100% 1-NN; Fisher noise=1.74 vs blur=23.87; purity=1.0 at sev≥0.7 |
| 359 | Dimensionality Reduction | PCA d=3 AUROC=1.0 fog/blur; RP beats PCA for noise; sparse 67% works |
| 360 | Robustness Certification | LOO 30/30 fog/night/blur; noise gap negative; certified sev blur≥0.1 |
| 361 | Transfer Detection | Cross-domain fails 41% degradation; universal cal catastrophic; night best transfer |
| 362 | Action Degradation | 63-88% tokens changed; cos_sim≈0; min=-0.785 reversed; blur degrades earliest |
